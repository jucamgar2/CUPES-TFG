...
public class AdministrationController {
    ...
    public ModelAndView imageStatistics(){
        ...
        res.addObject("initialsSuccess",df.format(imageService.getSuccesRateFromInitials(true)*100));
        res.addObject("initialsSuccess1",df.format(imageService.getSuccesRateFromInitialsAndShifts(true,1)*100));
        res.addObject("initialsSuccess2",df.format(imageService.getSuccesRateFromInitialsAndShifts(true,2)*100));
        res.addObject("initialsSuccess3",df.format(imageService.getSuccesRateFromInitialsAndShifts(true,3)*100));
        res.addObject("initialsSuccess4",df.format(imageService.getSuccesRateFromInitialsAndShifts(true,4)*100));
        res.addObject("noInitialsSuccess",df.format(imageService.getSuccesRateFromInitials(false)*100));
        res.addObject("noInitialsSuccess1",df.format(imageService.getSuccesRateFromInitialsAndShifts(false,1)*100));
        res.addObject("noInitialsSuccess2",df.format(imageService.getSuccesRateFromInitialsAndShifts(false,2)*100));
        res.addObject("noInitialsSuccess3",df.format(imageService.getSuccesRateFromInitialsAndShifts(false,3)*100));
        res.addObject("noInitialsSuccess4",df.format(imageService.getSuccesRateFromInitialsAndShifts(false,4)*100));
        res.addObject("yearSuccess",df.format(imageService.getSuccesRateFromYear(true)*100));
        res.addObject("yearSuccess1",df.format(imageService.getSuccesRateFromYearAndShifts(true,1)*100));
        res.addObject("yearSuccess2",df.format(imageService.getSuccesRateFromYearAndShifts(true,2)*100));
        res.addObject("yearSuccess3",df.format(imageService.getSuccesRateFromYearAndShifts(true,3)*100));
        res.addObject("yearSuccess4",df.format(imageService.getSuccesRateFromYearAndShifts(true,4)*100));
        res.addObject("noYearSuccess",df.format(imageService.getSuccesRateFromYear(false)*100));
        res.addObject("noYearSuccess1",df.format(imageService.getSuccesRateFromYearAndShifts(false,1)*100));
        res.addObject("noYearSuccess2",df.format(imageService.getSuccesRateFromYearAndShifts(false,2)*100));
        res.addObject("noYearSuccess3",df.format(imageService.getSuccesRateFromYearAndShifts(false,3)*100));
        res.addObject("noYearSuccess4",df.format(imageService.getSuccesRateFromYearAndShifts(false,4)*100));
