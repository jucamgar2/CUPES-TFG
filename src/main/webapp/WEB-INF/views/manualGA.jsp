...
<CUPES:layout title="Manual">
    ...
    <div class="block">
        ...
        <div class="manual">
            ...
            Para jugar al modo de juego un jugador, no será necesario haber iniciado sesión ni haberse registrado, puesto que es un modo de juego rápido y cuya finalidad es practicar, aunque, si hemos iniciado sesión, se guardarán nuestras estadísticas en este modo de juego. Una vez que en el selector de modos de juego pulsemos sobre jugar modo un jugador, la partida comenzará automáticamente y se nos mostrará la siguiente pantalla:
            <div class="pc-view">
            ...
            Si un jugador gasta todos sus intentos y no consigue adivinar a qué club pertenece el escudo, también será redireccionado a una página con el resultado de la partida donde se le indicará que ha perdido y se le mostrará el escudo completo para que de cara a una próxima partida lo conozca.
            <div class="pc-view">
