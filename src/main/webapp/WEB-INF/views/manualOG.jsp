...
<CUPES:layout title="Manual">
    ...
    <div class="block">
        ...
        <div class="manual">
            ...
            Para jugar una partida en línea, en primer lugar tendremos que habernos identificado en el sistema previamente y, tras identificarnos, tendremos dos opciones; podremos crear una partida o unirnos a una que ya esté creada y no haya empezado. Para cualquiera de las opciones, tendremos que ir a la página de modos de juego y ahí podremos seleccionar la opción que más nos convenza. Si decidimos crear una partida, la aplicación la creará y nos llevará al lobby. 
            <div class="pc-view">
            ...
            Sin embargo, si decidimos unirnos a una partida, puede que tengamos que esperar y mientras esperamos aparecerá el siguiente mensaje en la pantalla, aunque si hay partidas en las que todavía no se haya unido un segundo jugador, la pantalla no aparecerá, sino que directamente seremos direccionados al lobby de una partida. En la pantalla de espera, tendremos un pasatiempo que constará de un juego de memoria en el que le tendremos que dar la vuelta a las siguientes cartas de dos en dos para encontrar las parejas de escudos.
            <div class="pc-view">
            ...
            Una vez que un jugador gaste todos sus intentos o adivine los tres escudos, pasará a una página donde tendrá que esperar hasta que el otro jugador termine, para que la espera sea más amena. En esta pantalla también se ha incluido el pasatiempo donde hay que levantar las cartas de dos en dos para conseguir parejas.
            <div class="pc-view">
